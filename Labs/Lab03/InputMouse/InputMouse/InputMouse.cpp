...
LRESULT CALLBACK WinProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
     ...
     switch (message)
     {
	 case WM_MOUSEMOVE:                      // movimento
		 mouseX = LOWORD(lParam);
		 mouseY = HIWORD(lParam);
		 return 0;
	 case WM_LBUTTONDOWN:                    // botão esquerdo pressionado
		 mouseLB = true;
		 InvalidateRect(hwnd, NULL, TRUE);
		 return 0;
	 case WM_LBUTTONUP:                      // botão esquerdo liberado
		 mouseLB = false;
		 return 0;
	 case WM_MBUTTONDOWN:                    // botão do meio pressionado
		 mouseMB = true;
		 InvalidateRect(hwnd, NULL, TRUE);
		 return 0;
	 case WM_MBUTTONUP:                      // mouse - botão do meio liberado
		 mouseMB = false;
		 return 0;
	 case WM_RBUTTONDOWN:                    // botão direito pressionado
		 mouseRB = true;
		 InvalidateRect(hwnd, NULL, TRUE);
		 return 0;
	 case WM_RBUTTONUP:                      // botão direito liberado
		 mouseRB = false;
		 return 0;
