...
// 
// Criação:		13 Abr 2014
// Atualização:	07 Mai 2019
// Compilador:	Visual C++ 2019
//
// Descrição:	Demonstra como usar a Mouse para pintar pixels na tela.
//
**********************************************************************************/
...
LRESULT CALLBACK WinProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	 ...
	 case WM_MOUSEMOVE:                      // mouse - movimento
		 ...
		 return 0;
	 case WM_LBUTTONDOWN:                    // mouse - botão esquerdo pressionado
		 mouseLB = true;
		 InvalidateRect(hwnd, NULL, TRUE);
		 return 0;
	 case WM_LBUTTONUP:                      // mouse - botão esquerdo liberado
		 mouseLB = false;
		 return 0;
	 case WM_MBUTTONDOWN:                    // mouse - botão do meio pressionado
		 mouseMB = true;
		 InvalidateRect(hwnd, NULL, TRUE);
		 return 0;
	 case WM_MBUTTONUP:                      // mouse - botão do meio liberado
		 mouseMB = false;
		 return 0;
	 case WM_RBUTTONDOWN:                    // mouse - botão direito pressionado
		 mouseRB = true;
		 InvalidateRect(hwnd, NULL, TRUE);
		 return 0;
	 case WM_RBUTTONUP:                      // mouse - botão direito liberado
		 mouseRB = false;
		 return 0;
