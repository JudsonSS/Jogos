...
{ 
	switch(currState)
	{
	case LEFT:  spriteL->Draw(x, y, 0.2f); break;
	case RIGHT: spriteR->Draw(x, y, 0.2f); break;
	case UP:    spriteU->Draw(x, y, 0.2f); break;
	case DOWN:  spriteD->Draw(x, y, 0.2f); break;
	default: 
		switch(nextState)
		{
		case LEFT:  spriteL->Draw(x, y, 0.2f); break;
