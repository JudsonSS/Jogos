...
public:
	...
	void Draw(float x, float y, float z = 0.5f);				// desenha o quadro atual da animação
	void Draw(uint aFrame, float x, float y, float z = 0.5f);	// desenha um quadro da folha de sprites	
