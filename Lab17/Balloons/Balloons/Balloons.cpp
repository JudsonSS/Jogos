...
void Balloons::Update()
{
	...
	if (window->KeyCtrl(VK_LBUTTON) || window->KeyCtrl(VK_SPACE))
	{
...
void Balloons::Draw()
{
	...
	infoBar->Draw(window->CenterX(), window->Height() - 22.0f, Layer::MIDFRONT);
	popBox->Draw(65, window->Height() - 55.0f, Layer::MIDFRONT);
	lostBox->Draw(window->Width() - 65.0f, window->Height() - 55.0f, Layer::MIDFRONT);
